...
Minimal supported iOS version for Exponea SDK is 15.0, you may need to change iOS version on the first line of your `ios/Podfile` to `platform :ios, '15.0'`, or higher.
