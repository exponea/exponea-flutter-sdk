...
- ```
  ...
  ```
  The segmentation data update process requires to link IDs but that part of the process failed. Please refer to the error log messages and check your `ExponeaPlugin().identifyCustomer` usage. This  should not happen, please discuss this with the {user.br} support team.
- ```
